    ...
    <div className="bg-black text-white">
      <div className="flex flex-col items-center text-center py-10">
        ...
        <p className="text-lg md:text-2xl max-w-8xl mx-auto mt-5 px-5">
          Rupkala is more than just fashion—it’s a movement. Designed for Gen Z
          and college trendsetters, we blend trippy aesthetics with bold
          streetwear to create statement pieces that break the norm. Our designs
          are inspired by psychedelic art, underground culture, and urban street
          vibes, making every outfit a canvas for self-expression. We believe in
          fearless individuality, limited drops, and community-driven fashion.
          Whether you're hitting the streets or making waves at a festival,
          Rupkala keeps you wild, vibrant, and unapologetically you. Welcome to
          the future of street fashion. Stay wavy. Stay wild.
        </p>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center py-10">
        <div className="md:w-1/2 px-5 text-center md:text-left">
          ...
          <p className="text-lg mt-4">
            At Rupkala, we create trippy, street-style fashion for Gen Z. Our
      ...
      <div className="flex flex-col md:flex-row items-center py-10 ">
        ...
        <div className=" mt-5 md:w-1/2 px-5 text-center md:text-left">
          ...
          <p className="text-lg mt-4">
            Founded in 2024, Rupkala emerged as a bold fusion of trippy
            aesthetics and street fashion, crafted for Gen Z and college
            trendsetters. We set out to break the norm, designing vibrant,
            statement pieces that reflect individuality and self-expression.
          </p>
          <button className="bg-[#6C5DD3] px-6 py-2 rounded-xl mt-5 text-lg font-medium hover:bg-[#5a4bc4] cursor-pointer">
            More +
          </button>
      ...
      <footer className="grid grid-cols-1 md:grid-cols-4 gap-6 p-10">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-gray-400">Rupkala.fashion@gmail.com</p>
